        ...
        <div class="sidebar">
            ...
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item">
                        <a href="{{ route('satellites.index') }}" class="nav-link {{ request()->routeIs('satellites.*') && !request()->routeIs('satellites.live') ? 'active' : '' }}">
                    ...
                    <li class="nav-item">
                        <a href="{{ route('satellites.live') }}" class="nav-link {{ request()->routeIs('satellites.live') ? 'active' : '' }}">
